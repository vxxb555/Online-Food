...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]',address='$_POST[address]',email='$_POST[email]',phone='$_POST[phone]',password='$_POST[password]' where u_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="address" class="form-control" placeholder="xyz"  value="<?php  echo $newrow['address']; ?>">
                                                   </div>
                                            </div>
