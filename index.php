...
<head>
    ...
    <!--favicon❤️-->
  <link rel="icon" href="images/cook.png" type="image/png">
...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark fixed-top">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded mycooking" src="images/cook.png" alt="">MEAL ON WHEELS </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            
                            <li class="nav-item"> <a class="nav-link active nevu" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active nevu" href="restaurants.php">Restaurants <span class="sr-only"></span></a> </li>
                            <li class="nav-item"> <a class="nav-link active nevu" href="#aboutus">About Us <span class="sr-only"></span></a> </li>
                         <li class="nav-item"> <a class="nav-link active nevu" href="contactform.php">Contact <span class="sr-only"></span></a> </li>           
							<?php
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
									...
									echo  '<li class="nav-item"><a href="your_orders.php" class="nav-link active nevu">My Orders</a> </li>';
									echo  '<li class="nav-item"><a href="logout.php" class="nav-link active nevu">Logout</a> </li>';
							}
        ...
        <section class="hero bg-image dede" data-image-src="images/img/ff.jpg" >
...
<div class="about-container">
    ...
    <div class="text-container">
        <h1>About us</h1>
        <p>Launched in 2024, Our technology platform connects customers, restaurant partners and delivery partners, serving their multiple needs. Customers use our platform to search and discover restaurants <br>We Believe in Quality. All around. Quality food can’t be made without quality initiative. Find out about the general population driving "MEAL ON WHEELS"</p>
        <a href="">Read More</a>
    </div>
     ...
     <div class="container">
         <div class="row">
             <div class="section-title">
                 <h1>Our Team</h1>
                 <p>Teamwork has the incredible power to increase productivity, job satisfaction, and even each person's individual performance. </p>
             </div>
         </div>
         <div class="row">
             <div class="team-items">
                  <div class="item">
                      <img src="images/paa.jpg" alt="team" />
                      <div class="inner">
                          <div class="info">
                               <h5>Aryan Singh</h5>
                               <p>Web Developer</p>
                               <div class="social-links">
                                   ...
                                   <a href="https://twitter.com/i/flow/login"><span class="fa fa-twitter"></span></a>
                                   <a href="linkedin.com/login"><span class="fa fa-linkedin"></span></a>
                               </div>
                          </div>
                      </div>
                  </div>
                  <div class="item">
                      <img src="images/tani.jpeg" alt="team" />
                      <div class="inner">
                          <div class="info">
                               <h5>Tanishka Garg</h5>
                               <p>Web Developer</p>
                               <div class="social-links">
                                   <a href="mailto:aryansinghjaat9606@gmail.com" target="_blank"><span class="fa fa-facebook"></span></a>
                                   <a href="https://twitter.com/i/flow/login" target="_blank"><span class="fa fa-twitter"></span></a>
                                   <a href="linkedin.com/login"><span class="fa fa-linkedin"></span></a>
                               </div>
                          </div>
                      </div>
                  ...
                  <div class="item">
                      <img src="images/akash.png" alt="team" />
                      <div class="inner">
                          <div class="info">
        ...
        <footer class="footer">
            <div class="container">
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray handil">
                            <h5> Our Social Media Handles</h5>
                            
                                <a href="https://www.linkedin.com/in/aryan-singh-373a35218" target="_blank"><img src="images/faceb.png"> &nbsp  Facebook</a> <br> 
                              <br>
                                <a href="https:/www.instagram.com/yours_malikk" target="_blank"><img src="images/instag.png">  &nbsp Instagram</a> <bR>
                               <br>
                                <a href="https://twitter.com/avni_foundation" target="_blank"><img src="images/twit.png">  &nbsp Twitter</a>        
                        </div>
                        ...
                        <h5>Address</h5>
                                    <p>NEW DELHI, INDIA</p>
                                    <h5>Phone: +91 9193949606</a></h5> </div>


                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5><img src="images/small_aaa.png"> MEAL ON WHEELS</h5>
                                   <p>Our technology platform connects customers, restaurant partners and delivery partners, serving their multiple needs. Customers use our platform to search and discover restaurants We Believe in Quality. All around. Quality food can’t be made without quality initiative. Find out about the general population driving "MEAL ON WHEELS"</p>
                                </div>
                    </div>
                </div>
            </div>
